...
fernSeq1Inplace = partial(VNSeqMInplace, N=6, M=1, num_init_views=2, interval_epochs=500)
flowerSeq1Inplace = partial(VNSeqMInplace, N=9, M=1, num_init_views=3, interval_epochs=500)
fortressSeq1Inplace = partial(VNSeqMInplace, N=11, M=1, num_init_views=4, interval_epochs=500)
hornsSeq1Inplace = partial(VNSeqMInplace, N=17, M=1, num_init_views=6, interval_epochs=500)
leavesSeq1Inplace = partial(VNSeqMInplace, N=7, M=1, num_init_views=3, interval_epochs=500)
orchidsSeq1Inplace = partial(VNSeqMInplace, N=7, M=1, num_init_views=3, interval_epochs=500)
roomSeq1Inplace = partial(VNSeqMInplace, N=11, M=1, num_init_views=4, interval_epochs=500)
trexSeq1Inplace = partial(VNSeqMInplace, N=15, M=1, num_init_views=5, interval_epochs=500)
