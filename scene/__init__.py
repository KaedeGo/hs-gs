...
class Scene:
    ...
    gaussians : HorseshoeModel

    def __init__(self, args : ModelParams, gaussians : HorseshoeModel, load_iteration=None, shuffle=True, resolution_scales=[1.0], depth_scale=1.0):
        """b
